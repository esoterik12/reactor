...
const MemoryGame = ({ generatedContent }: SpotItGameProps) => {
  ...
  return (
    <section
      className={`${isFullscreen && 'p-4'} h-full page-background flex flex-col justify-between`}
      ref={containerRef}
    >
      {/* Selection Top Panel */}
      <div
      ...
      {/* Game Container */}
      <motion.div layout className='mt-2 flex h-screen w-full flex-row gap-2'>
